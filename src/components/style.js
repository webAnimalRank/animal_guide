...
export const Url2 = styled(Url).attrs({
	...
	&.sign::after {
		width: 1.6rem;
		background: url(${tom}) center / contain no-repeat;
	}
	&:hover::after {
...
export const Btn = styled.button.attrs({
	type: 'button',
	className: 'self-end rounded-lg px-3 py-1 font-bold hover:bg-white/10'
})``;

export const Btn2 = styled.button.attrs({
	type: 'button',
	className: 'rounded-lg px-2 py-1 font-bold hover:bg-white/10'
})``;
...
export const Icon = styled(NavLink).attrs({
	className: 'size-12 max-sm:size-9 p-1.5 rounded-full hover:bg-white/10'
})``;
