...
export default function Post() {
	...
	const { parsedBoardNo, data, loading, fetchError, actionError, isOwner, isProcessing, handleRemove } =
	...
	return (
		<Wrap className='font-(family-name:--f)'>
			<h2 className='self-start text-xl font-bold font-(family-name:--f2) flex gap-3 items-center'>{kindTitle}</h2>
