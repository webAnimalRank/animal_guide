  ...
  return (
    <div className='flex flex-col gap-4 px-20 max-lg:px-10 max-sm:px-5'>
      <Form className='relative'>
        <div className='pt-4 flex flex-col justify-center items-center self-center gap-4 font-extrabold text-2xl max-md:p-0 max-sm:text-xl'>
      ...
      <Edit onClick={() => setIsEdit(true)} disabled={loading}>
        수정
      </Edit>
